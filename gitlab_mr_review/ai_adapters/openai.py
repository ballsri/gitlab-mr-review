"""
OpenAI AI Adapter with optimized token usage and cost tracking
"""
...
class OpenAIAdapter(AIAdapter):
    """OpenAI AI adapter with GPT-5 support"""
    ...
    def __init__(
        ...
        *,
        ...
        # Get pricing for the model (default to gpt-5-2025-08-07 pricing)
        self.pricing = pricing_table.get(model_name, pricing_table['gpt-5-2025-08-07'])
    ...
    def _validate_bracket_balance(original: str, replacement: str) -> Tuple[bool, str]:
        ...
        """
        orig_brackets = OpenAIAdapter._count_brackets(original)
        repl_brackets = OpenAIAdapter._count_brackets(replacement)
    ...
    def build_review_prompt(self, mr_data: Dict[str, Any],
        ...
        """Build prompt for OpenAI review - optimized for token efficiency"""
        ...
        try:
            ...
            api_params = {
                ...
                "messages": [
                    {
                        "role": "system",
                        "content": "You are a code review assistant. You MUST respond with ONLY valid JSON. Never use markdown formatting, code blocks, or any text outside the JSON structure. Your entire response must be parseable as JSON."
                    },
                    {
                        "role": "user",
                        "content": prompt
            ...
            print(f"Token usage - Input: {usage_metadata.prompt_tokens}, Output: {usage_metadata.completion_tokens}, Total: {usage_metadata.total_tokens}")
